 ...
 * Class Builder.
 */
class MgQueryBuilder extends Builder
{
    /**
     ...
     * @inheritdoc
     */
    public function __construct(MgConnection $connection)
    {
        $this->connection = $connection;
        $this->grammar = new MgQueryGrammar();
        $this->processor = new MgQueryProcessor();
    }
     ...
     * @return $this
     */
    public function project($columns): static
    {
     ...
     */
    public function getFresh(array $columns = [], bool $returnLazy = false)
    {
