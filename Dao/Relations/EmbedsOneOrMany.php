...
abstract class EmbedsOneOrMany extends Relation
{
     ...
     * @param Builder $query
     * @param DaoModel $parent
     * @param DaoModel $related
     * @param string $localKey
     * @param string $foreignKey
     * @param string $relation
     */
    public function __construct(Builder $query, DaoModel $parent, DaoModel $related, string $localKey, string $foreignKey, string $relation)
    {
        $this->query = $query;
        $this->parent = $parent;
     ...
     * @return string
     */
    protected function whereInMethod($model, $key): string
    {
        return 'whereIn';
    }
}
